    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Raw Materials Master</h1>
                    <p className="text-sm text-gray-500">Manage your raw material inventory types</p>
                </div>
                {!showForm && (
                    <button
                        onClick={openNew}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
                        ...
                        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50 flex-shrink-0">
                            <div>
                                <h2 className="text-lg font-bold text-gray-900">{editingId ? "Edit Raw Material" : "Create Raw Material"}</h2>
                        ...
                        <div className="p-6 overflow-y-auto">
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    <label className="text-sm font-medium text-gray-700 block mb-3">New Fields (optional)</label>
                                    <div className="space-y-3">
                                        {attributes.map((a, idx) => (
                                            <div key={idx} className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-start bg-gray-50 p-3 rounded-xl border border-gray-100">
                                                {/* Key input removed - auto generated */}
                                                ...
                                                <div className="sm:col-span-4">
                                                    <input
                                                        ...
                                                        placeholder="Label"
                                                        className={`w-full rounded-lg border px-3 py-2 text-sm outline-none focus:border-blue-500 ${a.key === 'prodName' ? 'bg-gray-100 text-gray-500' : 'bg-white border-gray-300'}`}
                                                    />
                                                </div>
                        ...
                        <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-3 flex-shrink-0">
                            ...
                            >
                                {saving ? "Saving..." : (editingId ? "Update Raw Material" : "Save Raw Material")}
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                <div className="border-b border-gray-200 bg-slate-50 px-6 py-4 flex items-center justify-between gap-4">
                    <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider whitespace-nowrap">Raw Material List</h3>
                    <input
                        value={q}
